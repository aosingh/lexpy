...
class TesDAWGWordInsert(unittest.TestCase):
    ...
    def test_word_add(self):
        ...
        self.assertIsInstance(
            self.dawg, DAWG, "Object should be of type `lexpy.dawg.DAWG`"
        )
...
class TestDAWGPrefixExists(unittest.TestCase):
    def test_dawg_node_prefix_exists(self):
        ...
        self.assertTrue(
            self.dawg.contains_prefix("ash"), "Prefix should be present in DAWG"
        )
        self.assertTrue(
            self.dawg.contains_prefix("as"), "Prefix should be present in DAWG"
        )
        self.assertTrue(
            self.dawg.contains_prefix("a"), "Prefix should be present in DAWG"
        )
    ...
    def test_dawg_node_prefix_not_exists(self):
        ...
        self.assertEqual(2, self.dawg.get_word_count(), "Word count not equal")
        self.assertFalse(
            self.dawg.contains_prefix("xmas"), "Prefix should be present in DAWG"
        )
        self.assertFalse(
            self.dawg.contains_prefix("xor"), "Prefix should be present in DAWG"
        )
        self.assertFalse(
            self.dawg.contains_prefix("sh"), "Prefix should be present in DAWG"
        )
...
class TestDAWGPrefixSearch(unittest.TestCase):
    def test_dawg_prefix_search(self):
        ...
        self.assertEqual(
            sorted(self.dawg.search_with_prefix("ash")),
...
class TestSearchWithinDistance(unittest.TestCase):
    ...
    def test_edit_distance_search(self):
        ...
        self.assertListEqual(
            self.dawg.search_within_distance("arie", dist=2),
            ["arbil", "athie", "auric"],
        )
